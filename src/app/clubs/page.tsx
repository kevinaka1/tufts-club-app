                        ...
                        <div>
                            ...
                            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                                {categories.map((category) => {
                                    const isLiked = likedCategories.has(category);
                                    return (
                                        <div
                                            key={category}
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                className={`px-3 py-1 rounded-full text-sm whitespace-nowrap appearance-none ${selectedCategories.includes(category)
